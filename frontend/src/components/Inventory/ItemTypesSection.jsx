...
import { Add as AddIcon, DeleteOutline as DeleteIcon, DeleteSweep as DeleteSweepIcon } from '@mui/icons-material'; 
        ...
        <Paper className="inventory-paper"> 
            ...
            {itemTypes.length > 0 ? (
                    ...
                    {itemTypes.map((type) => (
                        ...
                        >
                            <Box className="item-type-info">
                                ...
                                <Typography component="strong" className="item-type-name">{type.name}</Typography>
             ...
             <AddItemTypeModal
                 ...
                 onClose={() => { setOpenAddTypeModal(false); setEditingType(null); }}
