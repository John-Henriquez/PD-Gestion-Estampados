    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ mb: 'var(--spacing-lg)' }}>
          Gracias por tu compra. Tu pedido con el número <strong>#{orderId}</strong> ha sido
          registrado exitosamente.
        </Typography>
        <Typography variant="body2" color="textSecondary" sx={{ mb: 'var(--spacing-xl)' }}>
          Recibirás una confirmación por correo electrónico pronto. Puedes revisar el estado de tus
